...
public class Test01Dis02Fragment extends Fragment  implements View.OnClickListener{
    ...
    public View onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_test_01_dis_02, container, false);
    }
    ...
    public void onClick(View view) {
        switch(view.getId()){
            ...
            case R.id.button_test_next:
                NavHostFragment.findNavController(Test01Dis02Fragment.this).navigate(R.id.action_navigation_test_01_dis_02_to_navigation_test_01_dis_03);
                break;
        }
    }
}
