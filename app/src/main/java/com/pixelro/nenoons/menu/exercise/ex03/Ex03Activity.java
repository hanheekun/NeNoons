...
import com.pixelro.nenoons.menu.exercise.ex02.Ex02AFragment;
...
public class Ex03Activity extends AppCompatActivity implements IEyeDistanceMeasureServiceCallback {
    ...
    private Ex03Activity.SendMassgeHandler mMainHandler = null;
    private Ex03Activity mThis03 = null;
        ...
        mConnection = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName className, IBinder service) {
                ...
                if (mEyeDistanceMeasureService != null) { // & mStartFlag == true) {
                    mBindStatus = true;
                    mEyeDistanceMeasureService.registerCallback_IEyeDistanceMeasureServiceCallback(TAG, mThis03);
                } else {
