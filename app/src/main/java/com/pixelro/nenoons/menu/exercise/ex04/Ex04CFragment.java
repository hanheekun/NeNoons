...
public class Ex04CFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_ex_04_c, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        exProfile.type = ExProfile.Type.TYPE_4;
        exProfile.date = formatNowDate.format(nowDate);
        exProfile.level = ((Ex04Activity)getActivity()).mCurLevel;
