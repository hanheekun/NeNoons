...
public class Ex02Activity extends AppCompatActivity implements IEyeDistanceMeasureServiceCallback {
    ...
    private Ex02Activity.SendMassgeHandler mMainHandler = null;
    private Ex02Activity mThis02 = null;
    ...
    private void initService() {    // added by Alex, 2018.08.20
        mMainHandler = new Ex02Activity.SendMassgeHandler();
        ...
        mConnection = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName className, IBinder service) {
                ...
                if (mEyeDistanceMeasureService != null) { // & mStartFlag == true) {
                    mBindStatus = true;
                    mEyeDistanceMeasureService.registerCallback_IEyeDistanceMeasureServiceCallback(TAG, mThis02);
                } else {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SEND_THREAD_DISTANCE_MEASURE_COMPLETE:
                    ...
                    Log.i(TAG, "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! = " + mLeftOpenValue+ ","+mRightOpenValue);
                    break;
