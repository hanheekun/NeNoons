...
public class Test02Rg02Fragment extends Fragment  implements View.OnClickListener{
    ...
    public View onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_test_02_gr_02, container, false);
    }
    ...
    public void onClick(View view) {
        switch(view.getId()){
            ...
            case R.id.button_test_next:
                NavHostFragment.findNavController(Test02Rg02Fragment.this).navigate(R.id.action_navigation_test_02_gr_02_to_navigation_test_03_diff);
                break;
